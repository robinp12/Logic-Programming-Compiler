...
import norswap.logic.scopes.DeclarationContext;
import norswap.logic.scopes.DeclarationKind;
import norswap.logic.scopes.RootScope;
...
public final class SemanticAnalysis
{
    ...
    private LogicNode inferenceContext;
     ...
     */
    public static Walker<LogicNode> createWalker (Reactor reactor)
    {
        ReflectiveFieldWalker<LogicNode> walker = new ReflectiveFieldWalker<>(
            LogicNode.class, PRE_VISIT, POST_VISIT);
    ...
    private void popScope (LogicNode node) {
        scope = scope.parent;
    }
    ...
    private boolean isReturnContainer (LogicNode node) {
    ...
    private Attribute[] getReturnsDependencies (List<? extends LogicNode> children) {
