package norswap.logic.scopes;

import norswap.logic.ast.RootNode;
import norswap.logic.types.*;
import norswap.uranium.Reactor;

import static norswap.logic.scopes.DeclarationKind.*;
...
public final class RootScope extends Scope
{
    ...
    public final SyntheticDeclarationNode print = decl("print", RULE);
    ...
    public RootScope (RootNode node, Reactor reactor) {
        ...
        reactor.set(print,  "type", new RuleType(StringType.INSTANCE, StringType.INSTANCE));
    }
