...
import norswap.logic.types.FloatType;
import norswap.logic.types.IntType;
import norswap.logic.types.StringType;
import norswap.logic.types.Type;
...
public final class Interpreter
{
    ...
    public Object interpret (LogicNode root) {
        try {
            return run(root);
    ...
    private <T> T get(LogicNode node) {
