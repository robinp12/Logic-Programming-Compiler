package norswap.logic.bytecode;

import norswap.logic.ast.*;
import norswap.logic.interpreter.Constructor;
import norswap.logic.scopes.Scope;
import norswap.logic.scopes.SyntheticDeclarationNode;
import norswap.logic.types.*;
...
import static norswap.logic.ast.BinaryOperator.*;
import static norswap.logic.bytecode.AsmUtils.*;
import static norswap.logic.bytecode.TypeUtils.fieldDescriptor;
import static norswap.logic.bytecode.TypeUtils.methodDescriptor;
import static norswap.logic.bytecode.TypeUtils.*;
 ...
 *     <li>{@code null}: {@link norswap.logic.bytecode.Null#INSTANCE}</li>
...
public class BytecodeCompiler
{
    ...
    private final ValuedVisitor<LogicNode, Object> visitor = new ValuedVisitor<>();
     ...
     */
    public CompilationResult compile (String binaryName, LogicNode root)
    {
    ...
    private Object run (LogicNode node) {
    ...
    private Object arrayLiteral (ArrayLiteralNode node)
    {
        ...
        if (compType instanceof IntType) {
            ...
            method.visitTypeInsn(ANEWARRAY, "norswap/logic/types/TypeType");
        } else if (compType instanceof FunType) {
            throw new UnsupportedOperationException("TODO"); // TODO
        } else if (compType instanceof NullType) {
            method.visitTypeInsn(ANEWARRAY, "norswap/logic/bytecode/Null");
    ...
    private boolean isShortCircuit (BinaryOperator op) {
        return op == AND || op == NAND || op == OR || op == NOR  || op == XOR || op == IMPLIC || op == EQUIV;
    }
     ...
     * given node.
     */
    private org.objectweb.asm.Type nodeAsmType (LogicNode node) {
     ...
     */
    private String nodeFieldDescriptor (LogicNode node) {
     ...
     */
    private Type implicitConversion (LogicNode left, LogicNode right) {
